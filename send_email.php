...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['fullname'], $_POST['email'], $_POST['message'])) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'kemboimichael52@gmail.com'; // SMTP username
            $mail->Password = 'kvna vmej tfpd bohu'; // SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Enable TLS encryption
            $mail->Port = 587; // TCP port to connect to

            // Recipients
            $mail->setFrom($email, $name);
            $mail->addAddress('kemboimichael52@gmail.com'); // Add a recipient
